...
import com.osecurityapp.SignInActivity;


public class UserFilesFragment extends FragmentBase {
    ...
    /** Log tag. */
    private static final String LOG_TAG = UserFilesFragment.class.getSimpleName();
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_user_files, container, false);
    }
    ...
    private void upload(final String bucket, final Regions region) {
        AWSMobileClient.defaultMobileClient()
                .createUserFileManager(bucket, S3_PREFIX_UPLOADS, region,
                        new UserFileManager.BuilderResultHandler() {
                            ...
                            public void onComplete(final UserFileManager userFileManager) {
                                ...
                                UserFilesFragment.this.userFileManager = userFileManager;
